                ...
                <div className="">
                  <div className="card-body p-md-5">
                    ...
                    <form>
                      ...
                      {userData.newUser && <p>Please create a new account</p>}
                      ...
                      <div data-mdb-input-init className="form-outline mb-4">
                        <input
                          type="email"
                          id={`form2Example11${userData.newUser ? "1" : "2"}`}
                          key={`form2Example11${userData.newUser ? "1" : "2"}`}
                          className="form-control"
                          placeholder="Email"
                      ...
                      <div data-mdb-input-init className="form-outline mb-4">
                        <input
                          type="password"
                          key={`form4Example22${userData.newUser ? "1" : "2"}`}
                          id={`form4Example22${userData.newUser ? "1" : "2"}`}
                          className="form-control"
